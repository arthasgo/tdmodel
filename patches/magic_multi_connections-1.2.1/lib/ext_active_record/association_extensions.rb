    ...
    module ClassMethods
      ...
      def create_has_many_reflection(association_id, options, &extension)
          options.assert_valid_keys(
            ...
            :extend,
            :mirror_db_connection].concat(valid_keys_for_has_many_association).uniq
          )
        ...
        def create_has_one_reflection(association_id, options)
          options.assert_valid_keys(
            ...
            :mirror_db_connection].concat(valid_keys_for_has_one_association).uniq
          )
        ...
        def create_belongs_to_reflection(association_id, options)
          options.assert_valid_keys(
            ...
            :counter_cache, :extend, :polymorphic,:primary_key,
            :mirror_db_connection].concat(valid_keys_for_belongs_to_association).uniq
          )
        ...
        def create_has_and_belongs_to_many_reflection(association_id, options, &extension)
          options.assert_valid_keys(
            ...
            :before_add, :after_add, :before_remove, :after_remove, 
            :extend,
            :mirror_db_connection].concat(valid_keys_for_has_and_belongs_to_many_association).uniq
          )
